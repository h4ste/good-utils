...
public enum UmlsTermTypes implements RestParameterValue {
    ...
    CDO, // JsonConcept domain
    CD, // Clinical Drug
    CE, // Entry term for a Supplementary JsonConcept
    ...
    CPR, // JsonConcept property
    CP, // ICPC component process (in original form)
    CR, // JsonConcept relationship
    ...
    NA, // Name aliases
    NM, // Name of Supplementary JsonConcept
    ...
    PCE, // Preferred entry term for Supplementary JsonConcept
